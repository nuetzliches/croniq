...
- [ ] Dokumentiere alle Sequenz- und Architekturdiagramme direkt in Mermaid-Codeblöcken innerhalb der Markdown-Dateien (siehe Richtlinie in `docs/deep-dive/docstreams.md`).
