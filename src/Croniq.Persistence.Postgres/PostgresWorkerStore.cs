...
public sealed class PostgresWorkerStore : IWorkerStore
{
    private readonly IDbContextFactory<PostgresDbContext> _dbFactory;
    private readonly WorkerStoreOptions _options;

    public PostgresWorkerStore(IDbContextFactory<PostgresDbContext> dbFactory, IOptions<WorkerStoreOptions> options)
    {
