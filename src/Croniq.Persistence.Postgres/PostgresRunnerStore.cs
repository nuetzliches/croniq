...
INSERT INTO ""croniq"".""Runners"" (""TenantId"", ""EnvironmentTag"", ""RunnerId"", ""LastSeenAtUtc"", ""ExpiresAtUtc"", ""MetadataJson"", ""CreatedAtUtc"", ""UpdatedAtUtc"")
VALUES ({scope.TenantId}, {scope.EnvironmentTag}, {runnerId}, {lastSeenAtUtc}, {expiresAtUtc}, {heartbeat.MetadataJson}, {nowUtc}, {nowUtc})
ON CONFLICT (""TenantId"", ""EnvironmentTag"", ""RunnerId"") DO UPDATE SET
