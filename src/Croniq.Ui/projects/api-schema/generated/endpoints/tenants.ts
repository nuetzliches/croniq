...
export const TenantsApi: EndpointDefinition[] = [
    ...
    {
        method: 'get',
        path: '/tenants/:tenantId/calendars',
        description: `Returns all calendar definitions for the tenant/environment scope.`,
        requestFormat: 'json',
        parameters: [
            { name: 'tenantId', type: 'Path', schema: z.string() },
            {
        ...
        response: z.array(CalendarResponse),
    },
    {
        method: 'post',
        path: '/tenants/:tenantId/calendars',
        description: `Creates or updates a calendar definition for the tenant/environment scope.`,
        requestFormat: 'json',
        parameters: [
            {
                name: 'body',
                type: 'Body',
                schema: CroniqCalendarSeedDefinition,
            },
            { name: 'tenantId', type: 'Path', schema: z.string() },
            {
                name: 'environment',
        ...
        response: CalendarUpsertResult,
        errors: [{ status: 400, description: `Bad Request`, schema: z.void() }],
    },
    {
        method: 'get',
        path: '/tenants/:tenantId/calendars/:calendarId',
        description: `Returns the calendar definition for the requested calendar id.`,
        requestFormat: 'json',
        parameters: [
            { name: 'tenantId', type: 'Path', schema: z.string() },
    ...
    },
    {
        method: 'delete',
        path: '/tenants/:tenantId/calendars/:calendarId',
        description: `Deletes the calendar definition for the tenant/environment scope.`,
        requestFormat: 'json',
        parameters: [
            { name: 'tenantId', type: 'Path', schema: z.string() },
            { name: 'calendarId', type: 'Path', schema: z.string() },
    ...
    {
        method: 'get',
        path: '/tenants/:tenantId/webhooks/activity/stream',
        description: `Server-sent events stream for webhook activity updates.`,
        requestFormat: 'json',
        parameters: [
            { name: 'tenantId', type: 'Path', schema: z.string() },
            {
