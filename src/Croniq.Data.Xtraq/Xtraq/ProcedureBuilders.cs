...
public static class ProcedurePipelineExtensions
{
    ...
    public static async ValueTask<ProcedureCallPipeline<TInput>> ConfigureProcedure<TRequest, TInput>(
        this IXtraqDbContext dbContext,
        TRequest request,
        Func<TRequest, IXtraqDbContext, CancellationToken, ValueTask<TInput>> mapper,
        CancellationToken cancellationToken = default)
    {
        ArgumentNullException.ThrowIfNull(dbContext);
        ArgumentNullException.ThrowIfNull(mapper);
        var input = await mapper(request, dbContext, cancellationToken).ConfigureAwait(false);
        return ProcedureCallPipeline<TInput>.Create(dbContext, input);
    }
    ...
    public static async ValueTask<ProcedureCallExecution<TInput, TResult>> BuildProcedure<TRequest, TInput, TResult>(
        this IXtraqDbContext dbContext,
        TRequest request,
        Func<TRequest, IXtraqDbContext, CancellationToken, ValueTask<TInput>> mapper,
        Func<IXtraqDbContext, TInput, CancellationToken, ValueTask<TResult>> executor,
    ...
    public static async ValueTask<ProcedureStreamPipeline<TInput, TRow>> ConfigureProcedureStream<TRequest, TInput, TRow>(
        this IXtraqDbContext dbContext,
        TRequest request,
        Func<TRequest, IXtraqDbContext, CancellationToken, ValueTask<TInput>> mapper,
        CancellationToken cancellationToken = default)
    ...
    public static async ValueTask<ProcedureStreamExecution<TInput, TRow, TUpstream, TUpstream>> BuildProcedureStream<TRequest, TInput, TRow, TUpstream>(
        this IXtraqDbContext dbContext,
        TRequest request,
        Func<TRequest, IXtraqDbContext, CancellationToken, ValueTask<TInput>> mapper,
        Func<IXtraqDbContext, TInput, Func<TRow, CancellationToken, ValueTask>, CancellationToken, ValueTask<TUpstream>> streamExecutor,
...
public sealed class ProcedureCallPipeline<TInput>
{
    ...
    public ValueTask<TResult> ExecuteAsync<TResult>(
        Func<IXtraqDbContext, TInput, CancellationToken, ValueTask<TResult>> executor,
        CancellationToken cancellationToken = default)
        => WithExecutor(executor).ExecuteAsync(cancellationToken);

    public ValueTask<TResult> ExecuteAsync<TResult>(
        Func<IXtraqDbContext, Func<TInput, CancellationToken, ValueTask<TResult>>> selector,
        CancellationToken cancellationToken = default)
    {
        ArgumentNullException.ThrowIfNull(selector);
        var executor = selector(_dbContext) ?? throw new InvalidOperationException("Procedure selector returned null executor.");
        return WithExecutor((_, input, token) => executor(input, token)).ExecuteAsync(cancellationToken);
    }
