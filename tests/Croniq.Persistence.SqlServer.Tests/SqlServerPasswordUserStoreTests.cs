...
[Trait(TestTraits.Component, "Auth.SqlServer")]
public sealed class SqlServerPasswordUserStoreTests : IAsyncLifetime
{
    private readonly SqlServerContainerFixture _sql;
    private ServiceProvider? _provider;
    private IPasswordUserStore? _store;

    public SqlServerPasswordUserStoreTests(SqlServerContainerFixture sql)
    {
        _sql = sql;
    }
