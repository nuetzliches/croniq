...
public sealed class PostgresApiKeyStoreTests : IAsyncLifetime
{
    ...
    public PostgresApiKeyStoreTests(PostgresContainerFixture sql)
    {
        _sql = sql;
    }
    ...
    public async Task InitializeAsync()
    {
        ...
        await PostgresDatabaseMigrator.EnsureTenantExistsAsync(_sql.ConnectionString, "tenant-sql");
