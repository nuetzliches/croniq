...
public sealed class PostgresWebhookActivityStoreTests : IAsyncLifetime
{
    ...
    public PostgresWebhookActivityStoreTests(PostgresContainerFixture sql)
    {
        _sql = sql;
    }
    ...
    public async Task InitializeAsync()
    {
        ...
        await PostgresDatabaseMigrator.EnsureTenantExistsAsync(_sql.ConnectionString, TenantId);
