...
public sealed class PostgresWebhookDeadLetterStoreTests : IAsyncLifetime
{
    ...
    public PostgresWebhookDeadLetterStoreTests(PostgresContainerFixture sql)
    {
        _sql = sql;
    }
    ...
    public async Task InitializeAsync()
    {
        ...
        await PostgresDatabaseMigrator.EnsureTenantExistsAsync(_sql.ConnectionString, "tenant-replay");
