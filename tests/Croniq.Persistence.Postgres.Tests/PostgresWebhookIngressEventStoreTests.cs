...
public sealed class PostgresWebhookIngressEventStoreTests : IAsyncLifetime
{
    ...
    public PostgresWebhookIngressEventStoreTests(PostgresContainerFixture sql)
    {
        _sql = sql;
    }
    ...
    public async Task InitializeAsync()
    {
        ...
        await PostgresDatabaseMigrator.EnsureTenantExistsAsync(_sql.ConnectionString, "tenant-ingress");
