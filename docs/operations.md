...
services:
  ...
  ui:
    image: ghcr.io/nuetzliches/croniq-ui:0.39.1   # same tag as the server
    restart: unless-stopped

  server:
    image: ghcr.io/nuetzliches/croniq-server:0.39.1
    restart: unless-stopped
    volumes:
...
`croniq-ui:0.39.1` against `croniq-server:0.39.0` gives you a dashboard calling
