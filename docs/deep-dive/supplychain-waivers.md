...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| WAIVER-YYYYMMDD-01 | e.g. `Croniq.Api image` | `ghcr.io/<owner>/croniq-api@sha256:...` | CVE-2025-12345 | HIGH | 2026-01-15 | @owner | Pending upstream patch; blocked behind mTLS + WAF rule | [https://github.com/example/croniq/issues/123](https://github.com/example/croniq/issues/123) |
