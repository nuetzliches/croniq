 ...
 *
 * The runners feed (`api/hooks.ts`) and the log console (`pages/ConsolePage.tsx`)
 * each grew their own `fetch` + `ReadableStream` reader, with the same frame
