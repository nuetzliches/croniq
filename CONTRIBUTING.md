...
- The Angular MCP server described in the concept document is optional and dev-only; if you use it, capture any new scaffolding recipes in `.vscode/tasks.json` or docs so other contributors can reproduce them.
