...
$env:Croniq__Auth__InMemory__TenantReference = Get-EnvOrDotenv 'CRONIQ_CORE_TENANT_REFERENCE' ''
...
$env:Croniq__Core__TenantReference = Get-EnvOrDotenv 'CRONIQ_CORE_TENANT_REFERENCE' ''
